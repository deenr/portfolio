export function Experience({ className }: { className?: string }) {
  return (
    <section className={`w-full p-7 flex flex-col bg-white dark:bg-black dark:bg-opacity-50 rounded-[32px] ${className}`}>
      ...
      <p className="mt-3 text-primary-500 text-3xl	font-medium">Frontend Developer</p>
      <div className="mt-1 flex flex-row justify-between text-gray-500 dark:text-gray-300 text-sm">
