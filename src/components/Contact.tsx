  ...
  return (
    <section className={`w-full p-7 flex flex-col bg-white dark:bg-black dark:bg-opacity-50 rounded-[32px] ${className}`}>
      ...
      <div className="mt-3 flex grow flex-col gap-4">
        ...
        <button className="group w-fit h-fit flex flex-row items-center gap-1.5 py-3 px-4 rounded-[32px] overflow-hidden border-[1px] border-dashed border-gray-300 dark:border-gray-600 text-sm text-dark-900 dark:text-white hover:bg-gray-50 dark:hover:bg-white dark:hover:bg-opacity-10">
